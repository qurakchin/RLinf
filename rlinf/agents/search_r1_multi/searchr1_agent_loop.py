...
class Searchr1ToolAgentLoopWorker(MultiTurnAgentLoopWorker):
    ...
    def __init__(
        ...
        self.max_turns = self.cfg.tools.maxturn
    ...
    async def run_one_query(self, prompt_ids: list[int], *, answer) -> AgentLoopOutput:
        ...
        # calc reward_score
        reward_score = compute_score(final_answer, answer)
        trace_prints.append({"reward_score": reward_score})
