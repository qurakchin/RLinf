...
from rlinf.data.tool_call.tool_io_struct import ToolChannelResponse
...
class ToolParser(ABC):
    ...
    @abstractmethod
    async def extract_tool_calls(self, text) -> tuple[str, list[FunctionCall]]:
        """Extract tool calls from the responses."""
        raise NotImplementedError

    @classmethod
    def get_tool_parser(cls, name: str):
...
class HermesToolParser(ToolParser):
    ...
    async def extract_tool_calls(self, text: str) -> tuple[str, list[FunctionCall | ToolChannelResponse]]:
        ...
        for match in matches:
            try:
                ...
                logger.info(f"Success decode tool call")
