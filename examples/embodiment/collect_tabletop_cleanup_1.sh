...
export RLINF_LOG_DIR="${RLINF_LOG_DIR:-${REPO_PATH}/logs/tabletop_cleanup/variant_1/$(date +'%Y%m%d-%H:%M:%S')}"
...
echo "[采集组 A / 入口 1] 左右以 top 相机画面为准"
echo "[入袋规则] 左袋：百事可乐；右袋：可口可乐"
