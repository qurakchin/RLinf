...
RL_TRAINING_CONFIG: Dict[str, Any] = {
    ...
    "actor_rollout_ref": {
        ...
        "model": {
            "path": "/mnt/public/hf_models/Qwen2.5-1.5B-Instruct",  # Default model
    ...
    "trainer": {
        ...
        "critic_warmup": 0,
        "logger": ["console", "tensorboard"],  # Disable wandb for easier local debugging, add back when needed
...
def config_train_single_gpu() -> Dict[str, Any]:
    ...
    config["actor_rollout_ref"]["rollout"]["log_prob_micro_batch_size_per_gpu"] = 4
