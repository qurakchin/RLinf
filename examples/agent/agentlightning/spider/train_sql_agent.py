...
RL_TRAINING_CONFIG: Dict[str, Any] = {
    ...
    "data": {
        "train_files": "/mnt/public/yule/verl_agl/agent-lightning/examples/spider/data/train_spider.parquet",
        "val_files": "/mnt/public/yule/verl_agl/agent-lightning/examples/spider/data/test_dev_500.parquet",
        "train_batch_size": 64,
    ...
    "actor_rollout_ref": {
        ...
        "model": {
            "path": "/mnt/public/yule/models/Qwen2.5-Coder-1.5B-Instruct",
...
def train(config: Dict[str, Any], active_agent: Optional[str], trajectory: bool = False) -> None:
...
def main() -> None:
    ...
    parser.add_argument(
        "--trajectory", action="store_true", help="Enable trajectory level in trace aggregator"
    )
    ...
    print(f"Trajectory level: {args.trajectory}")

    train(config, active_agent, trajectory=args.trajectory)
