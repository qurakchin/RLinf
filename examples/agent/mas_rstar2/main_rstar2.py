...
from rlinf.agents.mas_rstar2.http_tool_worker import HttpToolWorker
from rlinf.agents.mas_rstar2.rstar2_agent_loop import MasRstar2AgentLoopWorker
...
def main(cfg) -> None:
    ...
    agentloop_group = MasRstar2AgentLoopWorker.create_group(
